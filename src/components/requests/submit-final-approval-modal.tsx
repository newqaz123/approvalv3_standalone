...
interface SubmitFinalApprovalModalProps {
	open: boolean;
...
export { CustomApprovalPicker as SubmitFinalApprovalPickerHarness };

export function SubmitFinalApprovalModal({
	open,
	onOpenChange,
	data,
	availableUsers,
				...
				<div className="min-h-0 flex-1 overflow-y-auto p-6 space-y-6 max-h-[calc(92svh-180px)] pointer-fine:max-h-[calc(90vh-180px)]">
					...
					<section className="bg-amber-50 dark:bg-amber-900/10 rounded-xl p-5 border border-amber-200 dark:border-amber-800/30">
						...
						<p className="text-sm text-slate-600 dark:text-slate-400 mb-4">
							Configure the final approval chain for this solution. The solution
							has already been approved by the engineering team.
						</p>
						...
						<div className="bg-white dark:bg-slate-900 rounded-lg p-4 border border-slate-200 dark:border-slate-800">
							...
							<p className="text-xs text-slate-500 mb-3">
								{useCustomHierarchy
									? "Define a custom approval chain for this solution."
