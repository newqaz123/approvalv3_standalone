...
interface CompletedSolutionModalProps {
	open: boolean;
...
export function CompletedSolutionModal({
	open,
	onOpenChange,
	data,
	userDepartment,
		...
		<Dialog open={open} onOpenChange={onOpenChange}>
			...
			/>
				...
				<div className="min-h-0 flex-1 overflow-y-auto p-6 space-y-6 max-h-[calc(92svh-140px)] pointer-fine:max-h-[calc(90vh-140px)]">
					{/* Completed Banner - Sent to Requester */}
					<div className="bg-purple-50 dark:bg-purple-900/10 rounded-xl p-4 border border-purple-200 dark:border-purple-800/30">
						<div className="flex items-start gap-3">
							...
							<div className="flex-1">
								<h4 className="text-sm font-bold text-purple-900 dark:text-purple-400">
									Solution Approved & Sent to Requester
								</h4>
								<p className="text-xs text-purple-600 dark:text-purple-300 mt-1">
									Sent on{" "}
									{format(new Date(data.sentToRequesterAt), "MMM d, yyyy")}
								</p>
								{data.requesterName && (
