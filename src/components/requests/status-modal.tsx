			...
			<div className="flex items-start gap-3">
				...
				<div className="flex-1">
					...
					<p className="text-xs text-red-600 dark:text-red-300 mt-1">
						...
						{format(new Date(rejection.rejectedAt), "MMM d, yyyy")}
					</p>
										...
										>
											...
											<div className="min-w-0 flex-1">
												<button
													...
													className="block max-w-full truncate text-left text-xs font-bold text-slate-900 underline-offset-4 hover:text-emerald-600 hover:underline focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 dark:text-slate-100"
												>
													{file.fileName}
												</button>
												{file.description && (
										...
										>
											...
											<div className="min-w-0 flex-1">
												<button
													...
													className="block max-w-full truncate text-left text-xs font-bold text-slate-900 underline-offset-4 hover:text-purple-600 hover:underline focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 dark:text-slate-100"
												>
													{file.fileName}
												</button>
												{file.description && (
