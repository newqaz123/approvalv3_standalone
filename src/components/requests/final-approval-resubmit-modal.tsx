				...
				<div className="min-h-0 flex-1 overflow-y-auto p-6 space-y-6 max-h-[calc(92svh-180px)] pointer-fine:max-h-[calc(90vh-180px)]">
						...
						<div className="flex items-start gap-3">
							...
							<div className="flex-1">
								<h4 className="text-sm font-bold text-red-900 dark:text-red-400">
									Final Approval Rejected at Level{" "}
									{data.rejection.rejectedAtLevel}
								</h4>
					...
					<section className="bg-amber-50 dark:bg-amber-900/10 rounded-xl p-5 border border-amber-200 dark:border-amber-800/30">
						...
						<p className="text-sm text-slate-600 dark:text-slate-400 mb-4">
							The final approval was rejected. You can restart the process with
							the same or modified approval chain.
						</p>
				...
				<div className="px-6 py-4 bg-slate-50 dark:bg-slate-800/50 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between shrink-0">
					...
					<div className="flex gap-2">
						...
						>
							...
							{isSubmitting ? "Restarting..." : "Restart Final Approval"}
						</Button>
					</div>
				</div>
			</DialogContent>
